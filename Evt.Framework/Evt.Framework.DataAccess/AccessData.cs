...
namespace Evt.Framework.DataAccess
{
    ...
    /// 封装Access的访问方法
    /// </summary>
    internal sealed class AccessData : AbstractData, IData, IDisposable
    {
        #region Properties

        private string _connectionString = null;
        private bool _impersonated = false;
        private OleDbConnection _cnn = null;
        ...
        public AccessData(string connectionString, bool impersonated)
        {
        ...
        public void OpenConnection()
        {
            ...
            if (this._impersonated)
            {
                ...
                {
                    cnn = new OleDbConnection(this._connectionString);
